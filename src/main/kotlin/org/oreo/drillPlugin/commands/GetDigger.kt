...
class GetDigger : CommandExecutor {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<String>): Boolean {
        ...
        if (args.isEmpty()) {
            ...
            player.sendMessage("§aGave you a digger successfully.")
        } else {
            ...
            ItemManager.digger?.let { targetPlayer.inventory.addItem(it) }
            sender.sendMessage("§aSuccessfully gave a digger to $targetPlayerName.")
        }
